'''
python tsne_spk.py data_dir feat_file
'''
...
with open(join(data_dir, 'spk2utt')) as f:
    for line in f.read().splitlines():
        ...
        spk_feats = []
        for u in utts:
            utt_feat = kaldi_io_py.read_vec_flt(feats[u])
...
labels = []
print("creating labels for silhouetter score...")
...
plt.savefig(join(data_dir, 'tsne_uttxvector_baseline.png'), dpi=300)
